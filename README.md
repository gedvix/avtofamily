...
1. Добавить модуль публикации объявлений на сторонние площадки (av.by, abw.by, onliner.by, Instagram, Telegram и др.) через адаптеры.
2. Создать отдельный frontend (например, на Next.js) с SEO-оптимизацией и интеграцией с REST API.
3. Настроить CI/CD, мониторинг и логи.
